...
public interface GoVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link GoParser#slicType}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSlicType(GoParser.SlicTypeContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link GoParser#slic}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSlic(GoParser.SlicContext ctx);
	/**
