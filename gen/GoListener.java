...
public interface GoListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link GoParser#slicType}.
	 * @param ctx the parse tree
	 */
	void enterSlicType(GoParser.SlicTypeContext ctx);
	/**
	 * Exit a parse tree produced by {@link GoParser#slicType}.
	 * @param ctx the parse tree
	 */
	void exitSlicType(GoParser.SlicTypeContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link GoParser#slic}.
	 * @param ctx the parse tree
	 */
	void enterSlic(GoParser.SlicContext ctx);
	/**
	 * Exit a parse tree produced by {@link GoParser#slic}.
	 * @param ctx the parse tree
	 */
	void exitSlic(GoParser.SlicContext ctx);
	/**
