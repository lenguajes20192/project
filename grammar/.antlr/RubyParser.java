// Generated from c:\Users\jhons\PycharmProjects\project\grammar\Ruby.g4 by ANTLR 4.7.1
...
public class RubyParser extends Parser {
	...
	public static final int
		...
		RULE_int_t = 63, RULE_bool_t = 64, RULE_nil_t = 65, RULE_idd = 66, RULE_id_global = 67, 
	...
	public static final String[] ruleNames = {
		...
		"int_t", "bool_t", "nil_t", "idd", "id_global", "id_function", "terminator", 
		"else_token", "crlf"
	};
	...
	public static class Function_nameContext extends ParserRuleContext {
		...
		public IddContext idd() {
			return getRuleContext(IddContext.class,0);
		}
	...
	public static class IddContext extends ParserRuleContext {
		public TerminalNode ID() { return getToken(RubyParser.ID, 0); }
		public IddContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_idd; }
	}

	public final IddContext idd() throws RecognitionException {
		IddContext _localctx = new IddContext(_ctx, getState());
		enterRule(_localctx, 132, RULE_idd);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(799);
