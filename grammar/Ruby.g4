...
function_definition_param_id : idd;
...
function_named_param : idd op=ASSIGN ( int_result | float_result | string_result | dynamic_result );
...
array_selector : idd LEFT_SBRACKET ( int_result | dynamic_result ) RIGHT_SBRACKET
